...
def buy_etf(code):
    ...
    try:
        ...
        printlog('bought_list: ', bought_list, ' target_buy_count: ', target_buy_count )
        printlog(stock_name, "(" , code , ") : " , ' current_price : ' , current_price , ' target_price : ' , target_price , ' ma5 : ' , ma5_price , ' ma10 : ' , ma10_price )     
    ...
    try:
        ...
        while True:
            ...
            if t_9 < t_now < t_start and soldout == False:
                soldout = True      # 남아있는 주식이 있다면 전부 매도
                sell_all()
